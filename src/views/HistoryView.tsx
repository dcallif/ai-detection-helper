  ...
  if (history.length === 0) {
    return (
      <div className="max-w-3xl mx-auto text-center py-12">
        ...
        <h3 className="mt-2 text-lg font-medium text-gray-900 dark:text-gray-100">No history yet</h3>
      ...
      <div className="space-y-4">
        {history.map((item) => (
          ...
          >
            <div className="flex justify-between items-start mb-3">
              ...
              <div className="flex items-center space-x-2">
                <button
                  ...
                  className="text-gray-400 dark:text-gray-500 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200 flex items-center"
                  title="Copy content"
                >
                  {copiedId === item.id ? (
            ...
            <div className="mb-3">
              <p className="text-gray-800 dark:text-gray-200 line-clamp-2">{item.content}</p>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm text-gray-500 dark:text-gray-400">{item.results.summary}</span>
            </div>
          </div>
        ))}
      </div>
